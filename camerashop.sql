...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 21, 2016 at 04:06 AM
...
(54, 3, 6399630, 1, 6399630),
(54, 32, 12248550, 2, 24497100),
(55, 30, 738500, 1, 738500),
(55, 32, 12248550, 1, 12248550);
...
(54, '2016-10-19', 30896730, 23),
(55, '2016-10-20', 12987050, 23);
...
`UserID` int(12) NOT NULL,
  ...
  `Permissions` varchar(10) NOT NULL DEFAULT 'user',
...
(23, 'hieuntps02771', 'e10adc3949ba59abbe56e057f20f883e', 'Nguyễn Tấn Hiếu', 'hieuntps02771@fpt.edu.vn', 'admin', '', '', 0),
(25, 'acb', 'e10adc3949ba59abbe56e057f20f883e', 'Nguyễn Văn C', 'abc@yahoo.com', 'user', '', '', 0);
...
ALTER TABLE `orderdetails`
 ADD PRIMARY KEY (`OrderID`,`ProductID`), ADD KEY `PKMA_ID` (`ProductID`);
...
--
ALTER TABLE `orderdetails`
MODIFY `OrderID` int(12) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=56;
--
