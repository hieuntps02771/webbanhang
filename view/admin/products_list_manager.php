    ...
    <center><table border="0" width="840" class="products_list_manager">
        ...
        $result = $quest->getListPage($start,$display);
         ...
         while($set = $result->fetch())
         {
           ...
           <th><a href='?action=update_product&id=<?php echo "$set[ProductID]";?>'><img src="../control/images/update-icon.png" width="35px"/></a></th>
           <th><a href="?action=delete_product&id=<?php echo "$set[ProductID]";?>"><img src="../control/images/delete-icon.png" width="35px"/></a></th>
           </tr>
         <?php } ?>
